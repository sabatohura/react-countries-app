        ...
        <>
            <div className={`${displayMode ? 'bg-ThemeColor-DmDarkBlue' : 'bg-ThemeColor-BWhite'} mb-4` } >
              ...
              <div className=' h-auto w-28 m-2 p-2'>
                <h3 className='text-md font-medium whitespace-nowrap'>{country.name.common}</h3>
                <p className='country-info  '><span className='font-bold'>Population:</span> <span className='whitespace-nowrap'>{country.population}</span></p>
